...
public class OGRESerializerDataInputStream extends InputStream implements DataInput {
	public static int HEADER_STREAM_ID_EXT = 0x1000;

	public OGRESerializerDataInputStream(InputStream in) {
		this.in = in;
